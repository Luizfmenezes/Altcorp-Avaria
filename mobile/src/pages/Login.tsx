    ...
    <div className="relative flex min-h-screen flex-col overflow-hidden bg-ink-900 text-paper-50">
      ...
      <div className="relative flex flex-1 flex-col justify-center px-6">
        ...
        <form onSubmit={submit} className="space-y-4 animate-slide-up">
          <div>
            <label htmlFor={emailInputId} className="mb-2 block text-[10.5px] font-semibold uppercase tracking-[0.22em] text-ink-300">E-mail</label>
            <input id={emailInputId} type="email" required className="input" value={email} onChange={(e) => setEmail(e.target.value)} />
          </div>
          <div>
